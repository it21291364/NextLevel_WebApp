  ...
  return (
    <Router>
      <div className="App">
        ...
        <ProtectedRoute path="/admin/suppliers" isAdmin={true} component={SuppliersList} exact />
        <ProtectedRoute path="/admin/supplier" isAdmin={true} component={NewSupplier} exact />
        <ProtectedRoute path="/admin/supplier/:id" isAdmin={true} component={UpdateSupplier} exact />
        
        <ProtectedRoute path="/admin/deliveries" isAdmin={true} component={DeliveriesList} exact />
        <ProtectedRoute path="/admin/delivery" isAdmin={true} component={NewDelivery} exact />
        <ProtectedRoute path="/admin/delivery/:id" isAdmin={true} component={UpdateDelivery} exact />
