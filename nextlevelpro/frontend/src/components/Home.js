...
const Home = ({ match }) => {//match-->information about how a route matched the URL.
    ...
    useEffect(() => {//fetch the products from the backend API
        if (error) {
    ...
    if (keyword) {//if products available when searching count them
