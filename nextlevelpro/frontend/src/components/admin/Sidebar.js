        ...
        <div className="sidebar-wrapper">
            <nav id="sidebar">
                <ul className="list-unstyled components">
                    ...
                    <li>
                        <a href="#employeeSubmenu" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle"><i
                            className="fa fa-employee-hunt"></i> Employees</a>
                    ...
                    <li>
                        <a href="#supplierSubmenu" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle"><i
                            className="fa fa-supplier-hunt"></i> Suppliers</a>
                    ...
                    <li>
                        <a href="#deliverySubmenu" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle"><i
                            className="fa fa-delivery-hunt"></i> Deliveries</a>
                        <ul className="collapse list-unstyled" id="deliverySubmenu">
                            <li>
                                <Link to="/admin/deliveries"><i className="fa fa-clipboard"></i> All</Link>
                            </li>

                            <li>
                                <Link to="/admin/delivery"><i className="fa fa-plus"></i> Create</Link>
                            </li>
                        </ul>
                    </li>
