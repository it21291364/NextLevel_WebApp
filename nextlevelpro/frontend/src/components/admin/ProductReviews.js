...
const ProductReviews = () => {
    ...
    useEffect(() => {
        ...
        if (productId !== '') {// If productId has a value
    ...
    const deleteReviewHandler = (id) => {//delete a review with a given id and productId
    ...
    const setReviews = () => {//creates an object with columns and rows
        const data = {
            columns: [
                {
                    label: 'Review ID',
