...
import { updateDelivery, getDeliveryDetails, clearErrors } from '../../actions/deliveryActions'
...
const UpdateDelivery = ({ match, history }) => {
    ...
    const { loading, error: updateError, isUpdated } = useSelector(state => state.delivery);
    ...
    }, [dispatch, alert, error, isUpdated, history, updateError, delivery, deliveryId])
                    ...
                    <Fragment>
                        <div className="wrapper my-5">
                            <form className="shadow-lg" onSubmit={submitHandler} encType='multipart/form-data'>
                                ...
                                <div className="form-group">
                                    <label htmlFor="diliveryPerson_field">diliveryPerson</label>
                                    <input
                                        type="text"
